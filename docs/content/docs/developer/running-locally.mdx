...
- [CodeSandbox Account](https://codesandbox.io/) - Web browser
- [Anthropic Account](https://anthropic.com) - Claude AI is used to chat with your project
- [Morph Account](https://morphllm.com) - Morph is the model that apply code changes
